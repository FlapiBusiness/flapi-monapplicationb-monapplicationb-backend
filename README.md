# Flapi - monapplicationb monapplicationb - BackEnd
...
- Development-Remote : https://dev.monapplicationb.api.flapi.org
- Staging : https://staging.monapplicationb.api.flapi.org
- Production : https://monapplicationb.api.flapi.org
...
```bash
git clone git@github.com:FlapiBusiness/flapi-monapplicationb-monapplicationb-backend.git
```
...
- Un fichier **`.env.keys.monapplicationb`** est fourni pour montrer la structure des clés, sans valeurs réelles.
